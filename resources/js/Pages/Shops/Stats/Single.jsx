            ...
            <div>
                <LineChart skipAnimation={false}
                           ...
                           xAxis={[
                               {
                                   id: 'barCategories',
                                   data: Object.values(stats.data).map(v => v.hour),
                                   scaleType: 'utc',
                               },
                           ]}
                           yAxis={[
        ...
        <div className={'rounded-xl shadow p-5 m-10 dark:bg-neutral-800/30 dark:text-white'}>
            <table className={'table w-full text-left text-sm'}>
                ...
                <tr className={'select-none'}>
                    ...
                    <th className={'pb-10 font-black'}>Hour of the day</th>
                </tr>
                </thead>
                <tbody>
                {Object.values(stats.data).map((stat, i) =>
                    <tr
                        href={route('shop.single.stats.single', { shop_frontend_page: shop.id, date: stat.hour })}
                        as={'tr'} key={i}
                        className={'hover:bg-neutral-200/10 transition-all'}>
