...
export default function SearchArea ({ className, children, searchFocused, setSearchFocused }) {
  return <>
    <div className={' flex items-center justify-center duration-300 '
      ...
      <TextInput className={'w-full'} name={'nav_search'} icon={faSearch} placeholder={'Search...'}
