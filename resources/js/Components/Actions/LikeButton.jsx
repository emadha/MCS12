...
export default function LikeButton ({ className, item, display, iconClassName, showCount = true, showText = false }) {
    ...
    const { lang, protectedApi, rtl } = useContext(AppContext)
    ...
    function addToFavorite (e) {
        ...
        setButtonDisabled(1)
        protectedApi.post(route('actions.item.favorite'), { h: item.h }).then(res => {
            if (res.data) {
